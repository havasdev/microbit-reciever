...
public class Constants {
    ...
    public static final String NO_PAIRED_FOUND = "ペアリング中のmicro:bitsを見つけませんでした。";
    public static final String NONE_FOUND = "範囲内に待機中のmicro:bitsを見つけませんでした";
    public static final String FIND_HRM_MONITORS = "Find heart rate monitors";
    public static final String STOP_SCANNING = "スキャン停止";
